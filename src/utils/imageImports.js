...
const portfolioImages = import.meta.glob('/public/images/portfolio/*.{png,jpg,jpeg,svg,webp}', { 
  eager: true,
  as: 'url'
});

// Importar todas las imágenes del blog
const blogImages = import.meta.glob('/public/images/blog/*.{png,jpg,jpeg,svg,webp}', { 
  eager: true,
  as: 'url'
});
